...
void loop() {
  ...
  MagnetometerRaw raw = bussola.ReadRawAxis();
   ...
   Serial.print("[");
   Serial.print("US");	//Per il test i sensori sono stati eliminati
   Serial.print("|");	// e sostituiti con la scritta US, potete
   Serial.print("UC");	//aggiungere i sensori includendo il codide
   Serial.print("|");	//presente nell'esempio precedente
   Serial.print("UD");	
   Serial.print("|");
   Serial.print(gradi);
   Serial.print("]");
