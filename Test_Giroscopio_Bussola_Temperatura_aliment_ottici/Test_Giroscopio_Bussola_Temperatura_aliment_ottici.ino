  ...
  //Dichiaro le variabili per i sesori ottici
  int vLineaDx;
  int vLineaSx;
  int vLineaCDx;
  int vLineaCSx;
...
void loop() {
  ...
  Serial.println("[" + String(centimetriS) + "|" + String(centimetriC) + "|" + String(centimetriD) + "|" + String(gradi) + "|" + String(AcX) + "|" + String(AcY) + "|" + String(AcZ) + "|" + String(GyX) + "|" + String(GyY) + "|" + String(GyZ) + "|" + String(Umidita) + "|" + String(Temperatura) + "|" + String(alimentazione) + "|" + String(vLineaSx) + "|" + String(vLineaCSx) + "|" + String(vLineaCDx) + "|" + String(vLineaDx) + "]");
